    ...
    <main className="min-h-screen bg-linear-black text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-32 pb-20">
        ...
        <div className="space-y-8 text-sm text-white/60 leading-relaxed">
          <section>
            <h2 className="text-lg font-medium text-white mb-3">1. What We Collect</h2>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">3. Data Storage</h2>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-3">5. Data Sharing</h2>
          ...
          <section>
            ...
            <p>You may export, delete, or request a copy of your data anytime. Contact us at <a href="mailto:privacy@callnotepro.com" className="text-linear-indigo hover:underline">privacy@callnotepro.com</a>.</p>
          </section>

          <section>
            <h2 className="text-lg font-medium text-white mb-3">7. Security</h2>
          ...
          <section>
            ...
            <p>Privacy concerns: <a href="mailto:privacy@callnotepro.com" className="text-linear-indigo hover:underline">privacy@callnotepro.com</a></p>
          </section>
        </div>
      </div>
    </main>
