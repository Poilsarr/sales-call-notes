    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-medium tracking-tight text-gray-900">Create account</h1>
          <p className="text-gray-400 text-sm mt-1">Get started with Axion Studio.</p>
        </div>
        <SignUp
          appearance={{
            elements: {
