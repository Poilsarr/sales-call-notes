  ...
  return (
    <aside className="w-64 bg-zinc-900 border-r border-zinc-800 flex flex-col">
      ...
      <div className="p-3 border-t border-zinc-800">
        <button onClick={() => signOut()} className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-zinc-400 hover:text-white hover:bg-zinc-800/50 w-full transition-colors">
